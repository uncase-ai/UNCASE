...
def generate_certificate_pdf(input_md, output_pdf):
    ...
    for line in lines:
        ...
        if line.startswith("# "):
            ...
            # Word wrap para el título principal
            words = text.split()
            curr_title = ""
            for word in words:
    ...
    page.insert_text((page.rect.width - margin - 100, footer_y + 12), "Sello de Validez", fontsize=8, fontname=F_REG, color=COLOR_GOLD)

    doc.save(output_pdf)
    doc.close()

if __name__ == "__main__":
    generate_certificate_pdf("CERTIFICADO_ESTRATEGICO_UNCASE_V1.md", "CERTIFICADO_ESTRATEGICO_UNCASE_V1.pdf")
