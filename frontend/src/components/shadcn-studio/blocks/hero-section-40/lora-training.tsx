...
import { CheckIcon, CpuIcon, LockKeyholeIcon, MessageSquareTextIcon, RocketIcon } from 'lucide-react'
  ...
  return (
    <div className='flex max-md:flex-col max-md:space-y-8 md:items-start'>
      <WorkflowItem
        ...
        description='Quality-gated synthetic conversations, fully traceable, ready for fine-tuning.'
        time='Layer 4'
        hasMenu={false}
      ...
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <span className='text-muted-foreground text-sm'>LoRA / QLoRA method</span>
          </div>
          <div className='flex items-center gap-2'>
            <CheckIcon className='size-4.5 text-green-500' />
            <span className='text-muted-foreground text-sm'>10 chat format outputs</span>
          </div>
        </div>
      ...
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <div className='flex items-center gap-2'>
            <LockKeyholeIcon className='size-4.5 text-green-500' />
            <span className='text-muted-foreground text-sm'>Epsilon &le; 8.0</span>
          </div>
          <div className='flex items-center gap-2'>
            <LockKeyholeIcon className='size-4.5 text-green-500' />
            <span className='text-muted-foreground text-sm'>Extraction attack &lt; 1%</span>
          </div>
          <div className='flex items-center gap-2'>
            <CpuIcon className='size-4.5 text-blue-500' />
            <span className='text-muted-foreground text-sm'>transformers + peft + trl</span>
          </div>
        </div>
      ...
      <WorkflowItem
        ...
        description='50-150 MB LoRA adapter ready for deployment. 99.5% smaller than the base model.'
        time='$15-45 USD'
        hasMenu={false}
        delay={2.4}
        className='md:mt-17'
      >
        <div className='bg-muted space-y-2.5 rounded-lg px-2.5 py-3'>
          ...
          <div className='flex items-center gap-2'>
            <RocketIcon className='size-4.5 text-green-500' />
            <span className='text-muted-foreground text-sm'>10 chat formats supported</span>
          </div>
          <div className='flex items-center gap-2'>
            <RocketIcon className='size-4.5 text-green-500' />
            <span className='text-muted-foreground text-sm'>Full audit trail preserved</span>
          </div>
        </div>
      </WorkflowItem>
    </div>
